  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock seamless dining experiences with Restaurant Booking Engine - Streamlining reservations and menu management for restaurants, elevating customer service to new heights."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock seamless dining experiences with Restaurant Booking Engine - Streamlining reservations and menu management for restaurants, elevating customer service to new heights.`}
            </Text>
            <Box
